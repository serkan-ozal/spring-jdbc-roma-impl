...
public class ReflectionUtil {
	...
	public static Class<?> getNonPrimitiveType(String clsName) {
		...
		else if (clsName.equalsIgnoreCase("string")) {
			return String.class;
		}
		else if (clsName.equalsIgnoreCase("date")) {
			return Date.class;
		}
		else {
			try {
	...
	public static boolean canCreateInstance(Class<?> cls) {
		return cls.isInterface() == false && Modifier.isAbstract(cls.getModifiers()) == false;
	}

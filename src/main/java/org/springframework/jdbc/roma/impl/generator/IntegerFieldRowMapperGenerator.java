 ...
 * @author Serkan ÖZAL
 */
public class IntegerFieldRowMapperGenerator<T> extends AbstractRowMapperFieldGenerator<T> {

	public IntegerFieldRowMapperGenerator(Field field, ConfigManager configManager) {

 ...
 * @author Serkan ÖZAL
 */
public class DoubleFieldRowMapperGenerator<T> extends AbstractRowMapperFieldGenerator<T> {

	public DoubleFieldRowMapperGenerator(Field field, ConfigManager configManager) {
	...
	public String doFieldMapping(Field f) {
		...
		String setValueExpr = RESULT_SET_ARGUMENT + ".getDouble(\"" + columnName + "\")";
		if (paramType.equals(Double.class)) {
			setValueExpr = "Double.valueOf" + "(" + setValueExpr + ")";
		}
		return 
			wrapWithNullCheck(
